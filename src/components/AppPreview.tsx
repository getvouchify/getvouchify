...
const AppPreview = () => {
  return <section className="py-16 md:py-24 bg-gradient-to-b from-background to-secondary/10">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        ...
        duration: 0.6
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Get a sneak peek at how you'll discover and earn rewards in your city.</p>
        </motion.div>
